...
class ArrayTableViewController: UITableViewController {
    ...
    */
    let animalArray = [Animal(name: "Rover"), Animal(name: "Mittens"), Animal(name: "Ein"), AnimalSubClass(name: "Sadie")]
    //changed only the last element to display an instance of AnimalSubClass in the table
